...
class Agent(nn.Module):
    def __init__(self, state_dim,action_dim,learning_rate):
        ...
        self.layer_1_1 = nn.Linear(5,256)
        self.layer_1_2 = nn.Linear(256,32)
        
        self.layer_2_1 = nn.Linear(10,256)
        self.layer_2_2 = nn.Linear(256,32)
        
        self.layer_1 = nn.Linear(2,8)
        
        self.result_layer = nn.Linear(32+32+8,32)
        self.result_layer_2 = nn.Linear(32,self.action_dim)
...
model.load_state_dict(torch.load('./model_weights/seperate_model_300'))
